...
class EasyMotion {
    ...
    sortedSearch(position, search = '', options = {}) {
        ...
        outer: for (let lineIdx = lineMin; lineIdx < lineMax; lineIdx++) {
            const line = textEditor_1.TextEditor.getLine(lineIdx).text;
    ...
    getEasymotionMarkerBackgroundColor() {
        return this.getMarkerColor(configuration_1.configuration.easymotionMarkerBackgroundColor, 'activityBarBadge.background');
    }
    getEasymotionMarkerForegroundColorOneChar() {
        return this.getMarkerColor(configuration_1.configuration.easymotionMarkerForegroundColorOneChar, 'activityBarBadge.foreground');
    }
    getEasymotionMarkerForegroundColorTwoChar() {
        return this.getMarkerColor(configuration_1.configuration.easymotionMarkerForegroundColorTwoChar, 'activityBarBadge.foreground');
    }
    updateDecorations() {
