...
class DocumentChange {
    ...
    async do(undo = false) {
        if ((this.isAdd && !undo) || (!this.isAdd && undo)) {
            await textEditor_1.TextEditor.insert(this.text, this.start, false);
        }
        else {
            await textEditor_1.TextEditor.delete(new vscode.Range(this.start, this.end));
        }
    }
    /**
...
class HistoryTracker {
    ...
    _getDocumentText() {
        ...
        return (_b = (_a = this.vimState.editor) === null || _a === void 0 ? void 0 : _a.document.getText()) !== null && _b !== void 0 ? _b : '';
    }
    _getDocumentVersion() {
        var _a, _b;
        // vimState.editor can be undefined in some unit tests
        return (_b = (_a = this.vimState.editor) === null || _a === void 0 ? void 0 : _a.document.version) !== null && _b !== void 0 ? _b : -1;
    }
    _addNewHistoryStep() {
        this.historySteps.push(new HistoryStep({
    ...
    updateAndReturnMarks() {
        ...
        for (const mark of newMarks) {
            if (mark.position.isAfter(textEditor_1.TextEditor.getDocumentEnd())) {
                mark.position = textEditor_1.TextEditor.getDocumentEnd();
            }
        }
        return newMarks;
    }
