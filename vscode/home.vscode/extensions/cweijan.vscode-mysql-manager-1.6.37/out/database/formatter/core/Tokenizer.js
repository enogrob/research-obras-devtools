...
class Tokenizer {
    ...
    getWhitespaceToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.WHITESPACE,
    ...
    getLineCommentToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.LINE_COMMENT,
    ...
    getBlockCommentToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.BLOCK_COMMENT,
    ...
    getStringToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.STRING,
    ...
    getOpenParenToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.OPEN_PAREN,
    ...
    getCloseParenToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.CLOSE_PAREN,
    ...
    getPlaceholderTokenWithKey({ input, regex, parseKey }) {
        const token = this.getTokenOnFirstMatch({ input, regex, type: tokenTypes_1.default.PLACEHOLDER });
        if (token) {
    ...
    getOperatorToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.OPERATOR,
    ...
    getToplevelReservedToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.RESERVED_TOPLEVEL,
    ...
    getNewlineReservedToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.RESERVED_NEWLINE,
    ...
    getPlainReservedToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.RESERVED,
    ...
    getWordToken(input) {
        return this.getTokenOnFirstMatch({
            input,
            type: tokenTypes_1.default.WORD,
    ...
    getTokenOnFirstMatch({ input, type, regex }) {
        ...
        if (matches) {
            return { key: null, type, value: matches[1] };
        }
    }
}
