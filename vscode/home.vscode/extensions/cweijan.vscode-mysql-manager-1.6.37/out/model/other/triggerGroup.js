...
class TriggerGroup {
    constructor(host, user, password, port, database, certPath) {
        ...
        this.identify = `${this.host}_${this.port}_${this.user}_${this.database}_${Constants_1.ModelType.TRIGGER_GROUP}`;
    }
    getTreeItem() {
        return {
            label: "TRIGGER",
            collapsibleState: DatabaseCache_1.DatabaseCache.getElementState(this),
            contextValue: Constants_1.ModelType.TRIGGER_GROUP,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return QueryUnit_1.QueryUnit.queryPromise(yield ConnectionManager_1.ConnectionManager.getConnection(this), `SELECT TRIGGER_NAME FROM information_schema.TRIGGERS WHERE TRIGGER_SCHEMA = '${this.database}'`)
                ...
                tableNodes = tables.map((table) => {
                    return new Trigger_1.TriggerNode(this.host, this.user, this.password, this.port, this.database, table.TRIGGER_NAME, this.certPath);
                });
