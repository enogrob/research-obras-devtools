...
class FunctionGroup {
    constructor(host, user, password, port, database, certPath) {
        ...
        this.identify = `${this.host}_${this.port}_${this.user}_${this.database}_${Constants_1.ModelType.FUNCTION_GROUP}`;
    }
    getTreeItem() {
        return {
            label: "FUNCTION",
            collapsibleState: DatabaseCache_1.DatabaseCache.getElementState(this),
            contextValue: Constants_1.ModelType.FUNCTION_GROUP,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return QueryUnit_1.QueryUnit.queryPromise(yield ConnectionManager_1.ConnectionManager.getConnection(this), `SELECT ROUTINE_NAME FROM information_schema.routines WHERE ROUTINE_SCHEMA = '${this.database}' and ROUTINE_TYPE='FUNCTION'`)
                ...
                tableNodes = tables.map((table) => {
                    return new function_1.FunctionNode(this.host, this.user, this.password, this.port, this.database, table.ROUTINE_NAME, this.certPath);
                });
...
//# sourceMappingURL=functionGroup.js.map